package ru.protonmod.next.ui.icons
...
/**
 * Proton design system icons, taken from ProtonCore (GPL-3.0).
 *
...
object ProtonIcons {
    val ArrowDownCircle: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_arrow_down_circle)

    val ArrowDownLine: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_arrow_down_line)

    val ArrowDownToSquare: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_arrow_down_to_square)

    val ArrowInToRectangle: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_arrow_in_to_rectangle)
    ...
    val Bug: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_bug)

    val Buildings: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_buildings)

    val ChartLine: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_chart_line)

    val Checkmark: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_checkmark)
    ...
    val CirclesLock: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_circles_lock)
    ...
    val ExclamationCircle: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_exclamation_circle)

    val ExclamationTriangleFilled: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_exclamation_triangle_filled)

    val Eye: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_eye)

    val EyeSlash: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_eye_slash)

    val FileArrowIn: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_file_arrow_in)
    ...
    val Grid2: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_grid_2)

    val Grid3: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_grid_3)

    val Hourglass: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_hourglass)

    val House: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_house)

    val InfoCircle: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_info_circle)

    val Key: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_key)
    ...
    val Link: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_link)

    val ListBullets: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_list_bullets)

    val ListNumbers: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_list_numbers)
    ...
    val PaperPlane: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_paper_plane)
    ...
    val Shield: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_shield)

    val ShieldFilled: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_shield_filled)

    val ShieldHalfFilled: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_shield_half_filled)
    ...
    val Storage: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_storage)
    ...
    val ThreeDotsVertical: ImageVector
        @Composable get() = ImageVector.vectorResource(R.drawable.ic_proton_three_dots_vertical)
